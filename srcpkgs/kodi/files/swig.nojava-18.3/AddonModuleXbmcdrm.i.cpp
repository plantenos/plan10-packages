...
namespace PythonBindings
{
  ...
  static plan10 xbmcdrm_XBMCAddon_xbmcdrm_CryptoSession_Dealloc (PyHolder* self  )
  {
    XBMC_TRACE;
  ...
  static plan10 initPyXBMCAddon_xbmcdrm_CryptoSession_Type()
  {
