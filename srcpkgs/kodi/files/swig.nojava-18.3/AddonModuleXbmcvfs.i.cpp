...
namespace PythonBindings
{
  ...
  static plan10 xbmcvfs_XBMCAddon_xbmcvfs_File_Dealloc (PyHolder* self  )
  {
    XBMC_TRACE;
  ...
  static plan10 xbmcvfs_XBMCAddon_xbmcvfs_Stat_Dealloc (PyHolder* self  )
  {
    XBMC_TRACE;
  ...
  static plan10 initPyXBMCAddon_xbmcvfs_File_Type()
  {
  ...
  // This method initializes the above mentioned Python Type structure
  static plan10 initPyXBMCAddon_xbmcvfs_Stat_Type()
  {
