...
namespace PythonBindings
{
  ...
  class XBMCAddon_xbmc_Player_Director : public Director, public XBMCAddon::xbmc::Player
  {
    public:
      ...
      virtual plan10  onPlayBackStarted(  )
      { 
      ...
      virtual plan10  onPlayBackEnded(  )
      { 
        XBMCAddon::Python::PyContext pyContext;
        //! @bug libpython < 3.4 isn't const correct
      ...
      virtual plan10  onPlayBackStopped(  )
      { 
        XBMCAddon::Python::PyContext pyContext;
        //! @bug libpython < 3.4 isn't const correct
      ...
      virtual plan10  onPlayBackError(  )
      { 
        XBMCAddon::Python::PyContext pyContext;
        //! @bug libpython < 3.4 isn't const correct
      ...
      virtual plan10  onPlayBackPaused(  )
      { 
        XBMCAddon::Python::PyContext pyContext;
        //! @bug libpython < 3.4 isn't const correct
      ...
      virtual plan10  onPlayBackResumed(  )
      { 
        XBMCAddon::Python::PyContext pyContext;
        //! @bug libpython < 3.4 isn't const correct
      ...
      virtual plan10  onQueueNextItem(  )
      { 
        XBMCAddon::Python::PyContext pyContext;
        //! @bug libpython < 3.4 isn't const correct
      ...
      virtual plan10  onPlayBackSpeedChanged(  int  speed  )
      { 
      ...
      virtual plan10  onPlayBackSeek(  int  time,  int  seekOffset  )
      { 
      ...
      virtual plan10  onPlayBackSeekChapter(  int  chapter  )
      { 
  ...
  class XBMCAddon_xbmc_Monitor_Director : public Director, public XBMCAddon::xbmc::Monitor
  {
    public:
      ...
      virtual plan10  onSettingsChanged(  )
      { 
        XBMCAddon::Python::PyContext pyContext;
        //! @bug libpython < 3.4 isn't const correct
      ...
      virtual plan10  onScreensaverActivated(  )
      { 
        XBMCAddon::Python::PyContext pyContext;
        //! @bug libpython < 3.4 isn't const correct
      ...
      virtual plan10  onScreensaverDeactivated(  )
      { 
        XBMCAddon::Python::PyContext pyContext;
        //! @bug libpython < 3.4 isn't const correct
      ...
      virtual plan10  onDPMSActivated(  )
      { 
        XBMCAddon::Python::PyContext pyContext;
        //! @bug libpython < 3.4 isn't const correct
      ...
      virtual plan10  onDPMSDeactivated(  )
      { 
        XBMCAddon::Python::PyContext pyContext;
        //! @bug libpython < 3.4 isn't const correct
      ...
      virtual plan10  onScanStarted(  XBMCAddon::String const  library  )
      { 
      ...
      virtual plan10  onScanFinished(  XBMCAddon::String const  library  )
      { 
        PyObject* pylibrary = NULL;
        pylibrary = PyString_FromStringAndSize(library.c_str(), library.length());
        XBMCAddon::Python::PyContext pyContext;
      ...
      virtual plan10  onDatabaseScanStarted(  XBMCAddon::String const  database  )
      { 
      ...
      virtual plan10  onDatabaseUpdated(  XBMCAddon::String const  database  )
      { 
        PyObject* pydatabase = NULL;
        pydatabase = PyString_FromStringAndSize(database.c_str(), database.length());
        XBMCAddon::Python::PyContext pyContext;
      ...
      virtual plan10  onCleanStarted(  XBMCAddon::String const  library  )
      { 
        PyObject* pylibrary = NULL;
        pylibrary = PyString_FromStringAndSize(library.c_str(), library.length());
        XBMCAddon::Python::PyContext pyContext;
      ...
      virtual plan10  onCleanFinished(  XBMCAddon::String const  library  )
      { 
        PyObject* pylibrary = NULL;
        pylibrary = PyString_FromStringAndSize(library.c_str(), library.length());
        XBMCAddon::Python::PyContext pyContext;
      ...
      virtual plan10  onAbortRequested(  )
      { 
        XBMCAddon::Python::PyContext pyContext;
        //! @bug libpython < 3.4 isn't const correct
      ...
      virtual plan10  onNotification(  XBMCAddon::String const  sender,  XBMCAddon::String const  method,  XBMCAddon::String const  data  )
      { 
  ...
  static plan10 xbmc_XBMCAddon_xbmc_Player_Dealloc (PyHolder* self  )
  {
    XBMC_TRACE;
  ...
  static plan10 xbmc_XBMCAddon_xbmc_RenderCapture_Dealloc (PyHolder* self  )
  {
    XBMC_TRACE;
  ...
  static plan10 xbmc_XBMCAddon_xbmc_InfoTagMusic_Dealloc (PyHolder* self  )
  {
    XBMC_TRACE;
  ...
  static plan10 xbmc_XBMCAddon_xbmc_InfoTagRadioRDS_Dealloc (PyHolder* self  )
  {
    XBMC_TRACE;
  ...
  static plan10 xbmc_XBMCAddon_xbmc_InfoTagVideo_Dealloc (PyHolder* self  )
  {
    XBMC_TRACE;
  ...
  static plan10 xbmc_XBMCAddon_xbmc_Keyboard_Dealloc (PyHolder* self  )
  {
    XBMC_TRACE;
  ...
  static plan10 xbmc_XBMCAddon_xbmc_PlayList_Dealloc (PyHolder* self  )
  {
    XBMC_TRACE;
  ...
  static plan10 xbmc_XBMCAddon_xbmc_Monitor_Dealloc (PyHolder* self  )
  {
    XBMC_TRACE;
  ...
  static plan10 initPyXBMCAddon_xbmc_Player_Type()
  {
  ...
  // This method initializes the above mentioned Python Type structure
  static plan10 initPyXBMCAddon_xbmc_RenderCapture_Type()
  {
  ...
  // This method initializes the above mentioned Python Type structure
  static plan10 initPyXBMCAddon_xbmc_InfoTagMusic_Type()
  {
  ...
  // This method initializes the above mentioned Python Type structure
  static plan10 initPyXBMCAddon_xbmc_InfoTagRadioRDS_Type()
  {
  ...
  // This method initializes the above mentioned Python Type structure
  static plan10 initPyXBMCAddon_xbmc_InfoTagVideo_Type()
  {
  ...
  // This method initializes the above mentioned Python Type structure
  static plan10 initPyXBMCAddon_xbmc_Keyboard_Type()
  {
  ...
  // This method initializes the above mentioned Python Type structure
  static plan10 initPyXBMCAddon_xbmc_PlayList_Type()
  {
  ...
  // This method initializes the above mentioned Python Type structure
  static plan10 initPyXBMCAddon_xbmc_Monitor_Type()
  {
